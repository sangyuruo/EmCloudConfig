...
WORK_DIR=/opt/cloud
serviceJar="$WORK_DIR/EmCloudJhiWeb.war"
serviceNameLo="emcloudjhiweb"                                  # service name with the first letter in lowercase
serviceName="EmCloudJhiWeb"                                    # service name
...
javaCommandLineKeyword="EmCloudJhiWeb"                         # a keyword that occurs on the commandline, used to detect an already running service process and to distinguish it from others
